...
with open("../../../../ML_results/small_gene_count/classification_performance/model_baseline_comparaison.txt" , 'w') as f:
...
for model,model_ in zip (models,models_) :
    ...
    with open("../../../../ML_results/small_gene_count/classification_performance/model_baseline_comparaison.txt" , 'a') as f:
