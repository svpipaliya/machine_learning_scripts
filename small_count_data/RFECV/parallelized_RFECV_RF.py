...
visualizer = rfecv(estimator=trainedmodel ,
                   ...
                   scoring='accuracy' ,
                   random_state =RS, 
                   show=("../../../../ML_results/small_gene_count/feature_importance/parallelized_RF_optimal_nbr_features.png"))

visualizer.fit(X, y)        # Fit the data to the visualizer
visualizer.show("../../../../ML_results/small_gene_count/feature_importance/parallelized_RF_optimal_nbr_features.png") 
plt.close()
...
plt.savefig("../../../../ML_results/small_gene_count/feature_importance/parallelized_most_important_features_RF.png")
plt.close()
with open("../../../../ML_results/small_gene_count/feature_importance/parallelized_RF_most_important_genes.txt" , 'w') as f:
