...
visualizer = rfecv(estimator=trainedmodel ,
                   ...
                   scoring='accuracy' ,
                   random_state =RS, 
                   show=("../../../../ML_results/all_gene_count/feature_importance/RF_optimal_nbr_features_.png"))

visualizer.fit(X, y)        # Fit the data to the visualizer
visualizer.show("../../../../ML_results/all_gene_count/feature_importance/RF_optimal_nbr_features_.png") 
plt.close()
...
plt.savefig("../../../../ML_results/all_gene_count/feature_importance/most_important_features_RF_.png")
plt.close()
with open("../../../../ML_results/all_gene_count/feature_importance/RF_most_important_genes_.txt" , 'w') as f:
